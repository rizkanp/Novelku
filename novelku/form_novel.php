        ...
        <div class="col">
            <form action="?page=simpan_novel" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="judul_novel" class="form-control" placeholder="Judul Novel">
                </div>
                <div class="form-group">
                    <label>Masukkan Sinopsis</label>
                    <textarea name="sinopsis" rows="5" class="form-control" placeholder="Sinopsis"></textarea>
                </div>
                <div class="form-group">
