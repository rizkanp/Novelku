...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-secondary sign_in_button" href="?page=login">Sign In</a>
                    </li>
                    <?php } else{
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-secondary sign_in_button" href="?page=logout">Sign Out</a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
    ...
    $('.rating input').change(
        function() {
            if (this.value == 1) {
                $('.choice').text('Never Read Again');
            } else if (this.value == 2) {
                $('.choice').text('Great');
            } else if (this.value == 3) {
                $('.choice').text('Pretty Good');
            } else if (this.value == 4) {
                $('.choice').text('Strongly Recommended ');
            } else {
                $('.choice').text('Very Highly Recommended');
            }
