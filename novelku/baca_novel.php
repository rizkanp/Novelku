                        ...
                        <div class="col">
                            <form action="?page=simpan_review&id=<?= $row2['id_review']; ?>" method="post">
                                <div class="form-group">
                                    <label>Review</label>
                                    <textarea name="isi_review" rows="5" maxlength="250" placeholder="Masukkan isi review" class="form-control"><?= $row2['isi_review']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Rating</label>
                                    <br>
                                    <fieldset class="rating">
                                        <?php
                                        $mnrtkm = ['Kurang', 'Lumayan', 'Boleh boleh', 'Mantap jiwa', 'KEREN BANGET DAAAH'];
                                        $a = 5;
                                        while ($a >= 1) {
                                            if ($a == $row2['rating']) {
                                                $checked = "checked";
                                        ...
                                        ?>
                                            <input type="radio" id="bintang<?= $a; ?>" name="rating" value="<?= $a; ?>" <?= $checked; ?> />
                                    ...
                                    <br>
                                    <br>
                                    <div> <span class='choice'><?= $uwu ?></span></div>
                                </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="?page=simpan_review" method="post">
                                <div class="form-group">
                                    <label>Review</label>
                                    <textarea name="isi_review" rows="5" maxlength="250" placeholder="Masukkan isi review" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Rating</label>
                                    <br>
                                    ...
                                    <br>
                                    <br>
                                    <div>Menurut kamu novel ini <span class="choice">Kurang</span></div>
                                </div>
                        </div>
                    </div>
                </div>
