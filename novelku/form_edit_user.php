        ...
        <div class="col">
            <form action="?page=simpan_user&id=<?= $row['id_user']; ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_user" value="<?= $row['nama_user']; ?>" class="form-control" placeholder="Nama User ea">
                </div>
                <div class="form-group">
                    <label>Masukkan E-mail</label>
                    <input type="email" name="email" value="<?= $row['email']; ?>" class="form-control" placeholder="Email ea">
                </div>
                <div class="form-group">
                    <label>Masukkan Password</label>
                    <input type="password" name="password" value="<?= $row['password']; ?>" class="form-control" placeholder="Password ea">
                </div>
                <div class="form-group">
